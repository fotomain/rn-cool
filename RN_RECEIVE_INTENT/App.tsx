...
const App = () => {
    ...
    useEffect(() => {
//         console.log('Receive11 OK 00 ===',ReceiveSharingIntent);
//         console.log('Receive11 OK 00 getFileName ===',ReceiveSharingIntent?.utils.getFileName())

        ReceiveSharingIntent.getReceivedFiles((data:any)=> {
                alert('Receive12 OK  === '+data);
                alert('Receive13 OK  type === '+typeof (data));
                console.log('Receive1 OK 01 ===', data);
            ...
            (err:any)=>{
                // alert('Receive err === '+JSON.stringify(err));
                console.log('Receive0 err 01 ===', err);
                //=== do nothing: 1st step may be error - 2nd === OK
            });
